...
import { MixedRouteTrade, MixedRouteSDK } from '@baseswapfi/router-sdk'
import { Trade as V2Trade, Pair, Route as RouteV2 } from '@baseswapfi/v2-sdk'
import { Trade as V3Trade, Route as RouteV3, Pool, FeeOptions } from '@baseswapfi/v3-sdk2'
import { generatePermitSignature, toInputPermit, makePermit, generateEip2098PermitSignature } from './utils/permit2'
import { CurrencyAmount, Percent, TradeType } from '@baseswapfi/sdk-core'
...
describe('Uniswap', () => {
  ...
  before(async () => {
    ;({ WETH_USDC_V2 } = await getUniswapPools(FORK_BLOCK))
  })
